...
namespace backend.Controllers
{
    public class OrderController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerFirstName,CustomerLastName,CustomerMail,CustomerPhone,CustomerAdress,CustomerZip,CustomerCity,PriceTotal,VatTotal,DiscountTotal,OrderNumber,ReceiptNumber,PaymentMethod,Status")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
